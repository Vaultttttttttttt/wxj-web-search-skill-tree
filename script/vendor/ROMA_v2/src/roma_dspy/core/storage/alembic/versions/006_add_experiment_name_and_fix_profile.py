...
down_revision: Union[str, None] = (
    "01f9e9f52585"  # Points to latest head (rename_metadata_to_context_metadata)
)
...
def upgrade() -> None:
    ...
    op.create_index("ix_executions_experiment_name", "executions", ["experiment_name"])
    ...
    if "ix_executions_profile" not in existing_indexes:
        op.create_index("ix_executions_profile", "executions", ["profile"])
