...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_toolkit_traces_operation", "toolkit_traces", ["operation"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_toolkit_traces_success", "toolkit_traces", ["success"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_tool_invocations_toolkit_tool", table_name="tool_invocation_traces"
    )
