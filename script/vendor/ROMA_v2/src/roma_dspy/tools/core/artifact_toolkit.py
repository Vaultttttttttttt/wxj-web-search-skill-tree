...
class ArtifactToolkit(BaseToolkit):
    ...
    def _initialize_tools(self) -> None:
        ...
        self.enable_register = self.config.get("enable_register", True)
    ...
    def _is_tool_available(self, tool_name: str) -> bool:
        ...
        if tool_name == "register_artifact" and not self.enable_register:
            return False
        return True
            ...
            for idx, request in enumerate(requests_list):
                try:
                    ...
                    artifact = await self.artifact_builder.build(
                        ...
                        created_by_task=ExecutionContext.resolve_artifact_creator(),
